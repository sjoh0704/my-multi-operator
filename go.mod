module github.com/sjoh0704/my-multi-operator
...
require (
	...
	sigs.k8s.io/cluster-api-provider-aws v1.4.1
	sigs.k8s.io/controller-runtime v0.12.1
)

require sigs.k8s.io/json v0.0.0-20220525155127-227cbc7cc124 // indirect
